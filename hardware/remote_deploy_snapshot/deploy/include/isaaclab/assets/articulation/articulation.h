...
struct ArticulationData
{
    ...
    // Estimated/applied joint efforts in policy joint order.  On G1 hardware
    // this is MotorState::tau_est; unitree_mujoco publishes the matching
    // actuator-force sensor through the same DDS field.
